...
public class ParseSimilarOperation implements OwnAsyncTask<String, Void, List<BookModel>> {

    @Override
    public List<BookModel> doInBackground(final String response, final ProgressCallback<Void> progressCallback) throws IOException, ParserConfigurationException, SAXException {
        return XMLParser.parseSimilar(response);
    }
}